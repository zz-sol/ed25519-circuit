...
pub use proof::{
    ...
    AffineMulSampledSoundProof, AffineMulSampledSoundProofBundle, AffineMulSoundProofSettings,
    ...
    deserialize_affine_mul_sampled_sound_proof, downgrade_affine_mul_bundle_v2, prove_affine_mul,
    prove_affine_mul_batch, prove_affine_mul_bundle, prove_affine_mul_bundle_compressed,
    prove_affine_mul_bundle_v2, prove_affine_mul_e2e, prove_affine_mul_e2e_unified,
    prove_affine_mul_e2e_unified_with_settings, prove_affine_mul_e2e_with_settings,
    prove_affine_mul_fully_sound, prove_affine_mul_fully_sound_bundle,
    prove_affine_mul_fully_sound_bundle_with_settings, prove_affine_mul_fully_sound_strict,
    prove_affine_mul_fully_sound_strict_with_settings, prove_affine_mul_fully_sound_with_settings,
    prove_affine_mul_sampled_sound_bundle, prove_affine_mul_sampled_sound_bundle_with_settings,
    prove_affine_mul_sound, prove_affine_mul_sound_with_settings, prove_affine_mul_with_settings,
    ...
    prove_basepoint_affine_mul_fully_sound_with_settings, prove_basepoint_affine_mul_sound,
    prove_basepoint_affine_mul_with_settings, recode_affine_mul_bundle_v2_instance,
    serialize_affine_mul_bundle, serialize_affine_mul_bundle_v2, serialize_affine_mul_e2e_blob,
    ...
    serialize_affine_mul_sampled_sound_proof, try_deserialize_affine_mul_instance,
    try_deserialize_affine_mul_instance_auto, try_deserialize_affine_mul_instance_compressed,
    upgrade_affine_mul_bundle_to_v2, verify_affine_mul, verify_affine_mul_attested,
    verify_affine_mul_attested_with_settings, verify_affine_mul_batch, verify_affine_mul_bundle,
    verify_affine_mul_bundle_auto, verify_affine_mul_bundle_v2, verify_affine_mul_e2e,
    verify_affine_mul_e2e_unified, verify_affine_mul_e2e_unified_with_settings,
    verify_affine_mul_e2e_with_settings, verify_affine_mul_fully_sound,
    verify_affine_mul_fully_sound_bundle, verify_affine_mul_fully_sound_bundle_with_settings,
    verify_affine_mul_fully_sound_strict, verify_affine_mul_fully_sound_strict_with_settings,
    verify_affine_mul_fully_sound_with_settings, verify_affine_mul_sampled_sound_bundle,
    verify_affine_mul_sampled_sound_bundle_with_settings, verify_affine_mul_sound,
