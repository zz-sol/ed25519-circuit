...
pub use proof::{
    ...
    serialize_affine_mul_bundle_v2, serialize_affine_mul_instance,
    serialize_affine_mul_instance_compressed, serialize_affine_mul_proof,
    upgrade_affine_mul_bundle_to_v2, verify_affine_mul, verify_affine_mul_batch,
    verify_affine_mul_bundle, verify_affine_mul_bundle_auto, verify_affine_mul_bundle_v2,
    verify_affine_mul_with_settings, verify_basepoint_affine_mul,
    verify_basepoint_affine_mul_with_settings, recode_affine_mul_bundle_v2_instance,
};
