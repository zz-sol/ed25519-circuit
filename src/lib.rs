...
pub use proof::{
    ...
    verify_affine_mul_bundle_auto, verify_affine_mul_bundle_v2, verify_affine_mul_with_settings,
    verify_basepoint_affine_mul, verify_basepoint_affine_mul_with_settings,
};
