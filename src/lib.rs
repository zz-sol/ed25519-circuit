...
pub use proof::{
    ...
    AffineMulE2eProofBlob, AffineMulFullySoundProof, AffineMulFullySoundProofBundle, AffineMulSampledSoundProof,
    AffineMulSampledSoundProofBundle, AffineMulSoundProofSettings,
    ...
    deserialize_affine_mul_e2e_blob, deserialize_affine_mul_fully_sound_bundle, deserialize_affine_mul_fully_sound_proof,
    deserialize_affine_mul_instance_compressed, deserialize_affine_mul_proof,
    deserialize_affine_mul_sampled_sound_bundle, deserialize_affine_mul_sampled_sound_proof,
    ...
    prove_affine_mul_e2e, prove_affine_mul_e2e_unified, prove_affine_mul_e2e_unified_with_settings,
    prove_affine_mul_e2e_with_settings,
    prove_affine_mul_fully_sound, prove_affine_mul_fully_sound_bundle, prove_affine_mul_fully_sound_strict,
    prove_affine_mul_fully_sound_strict_with_settings, prove_affine_mul_fully_sound_with_settings,
    prove_affine_mul_fully_sound_bundle_with_settings, prove_affine_mul_sampled_sound_bundle,
    ...
    serialize_affine_mul_instance, serialize_affine_mul_instance_compressed, serialize_affine_mul_proof,
    serialize_affine_mul_fully_sound_proof, serialize_affine_mul_sampled_sound_bundle,
    serialize_affine_mul_sampled_sound_proof,
    ...
    verify_affine_mul_bundle_v2, verify_affine_mul_fully_sound, verify_affine_mul_fully_sound_bundle,
    verify_affine_mul_e2e, verify_affine_mul_e2e_unified, verify_affine_mul_e2e_unified_with_settings,
    verify_affine_mul_e2e_with_settings,
    verify_affine_mul_fully_sound_bundle_with_settings,
