...
pub use proof::{
    ...
    deserialize_affine_mul_sampled_sound_proof, prove_affine_mul, prove_affine_mul_batch,
    ...
    prove_affine_mul_sampled_sound_bundle_with_settings, prove_affine_mul_sound,
    ...
    verify_affine_mul, verify_affine_mul_batch, verify_affine_mul_bundle,
